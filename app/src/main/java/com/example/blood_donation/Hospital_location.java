...
public class Hospital_location extends FragmentActivity implements OnMapReadyCallback {
 ...
 NavigationView navigationView = findViewById(R.id.navigationView);
        ...
        mapsearchview.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (location != null) {
                    Geocoder geocoder = new Geocoder(Hospital_location.this);
                    try {
                    ...
                    public void onSuccess(Location location) {
                        if (location != null) {
                            ...
                            mMap.addMarker(new MarkerOptions().position(Sion_blood_component).title("Sion_blood_component")
                                    .icon(setIcon(Hospital_location.this,R.drawable.baseline_beenhere_24))
                                    .snippet(distance1));
...
// Check if Google Maps is available and start it
                            ...
                            Toast.makeText(Hospital_location.this, "Location not found", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
